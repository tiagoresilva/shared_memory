...
public class MemoryRead
{
    ...
    public static void Main()
    {
        ...
        ////Console.WriteLine("endereço base" + process.MainModule.BaseAddress);
        ...
        ReadProcessMemory((int)processHandleRead,  2750763200436, bufferRead, bufferRead.Length, ref bytesRead);
        //Console.WriteLine(0x0010 + hglobal.ToInt64());
        Console.WriteLine(Encoding.Unicode.GetString(bufferRead) +
           " (" + bytesRead.ToString() + "bytes)");
